...
const Profiledetails = () => {
    ...
    return (<>
        <header className="w-full h-screen px-2 py-4 flex flex-col justify-center items-center text-center bg-gray-900">
            <img className="inline-flex object-cover border-4 border-indigo-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 bg-indigo-50 text-indigo-600 h-24 w-24 !h-48 !w-48" src={`http://localhost:5000${localUserDetails?.profileImage || 'https://static.thenounproject.com/png/801397-200.png'}`}
                alt="" />
            ...
            <ul className="flex flex-row mt-2">
                <li className="mx-2">
                    <a href={localUserDetails?.github || '#'} target="_blank" aria-label="GitHub">
                ...
                <li className="mx-2">
                    <a href={localUserDetails?.linkedin || '#'} target="_blank" aria-label="LinkedIn">
                        <svg className="h-6 text-indigo-700 hover:text-indigo-300" fill="currentColor" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="mx-2">
                    <a href={localUserDetails?.twitter || '#'} target="_blank" aria-label="Twitter">
                        <svg className="h-6 text-indigo-700 hover:text-indigo-300" fill="currentColor" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>Twitter</title>
                            <path
                ...
                <li className="mx-2">
                    <a href={localUserDetails?.unsplash || '#'} target="_blank" aria-label="Unsplash">
                        <svg className="h-6 text-indigo-700 hover:text-indigo-300" fill="currentColor" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
