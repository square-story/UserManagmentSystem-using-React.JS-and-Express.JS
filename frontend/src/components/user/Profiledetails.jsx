...
const Profiledetails = () => {
    ...
    return (<>
        <header className="w-full h-screen px-2 py-4 flex flex-col justify-center items-center text-center bg-gray-900">
            <img className="inline-flex object-cover border-4 border-indigo-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 bg-indigo-50 text-indigo-600 h-24 w-24 !h-48 !w-48" src={localUserDetails?.profileImage ? `http://localhost:5000${localUserDetails?.profileImage}` : 'https://static.thenounproject.com/png/801397-200.png'}
                alt="" />
